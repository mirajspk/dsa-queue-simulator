...
void Vehicle::setRoute(Route route) {
    switch (route) {
        ...
        case Route::MOVE_A_TO_C:
            ...
            waypoints = {sf::Vector2f(590, 466.5), sf::Vector2f(590, 1100)}; 
            break;

        case Route::MOVE_C_TO_B:
            rectangle.setPosition(1100, 523.5);
            waypoints = {sf::Vector2f(580, 523.5), sf::Vector2f(580, 1100)}; 
            break;
        ...
        case Route::MOVE_C_TO_A:
            rectangle.setPosition(1100, 523.5);
            waypoints = {sf::Vector2f(493.5, 523.5), sf::Vector2f(493.5, -100)}; 
            break;
