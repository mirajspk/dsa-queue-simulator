...
int main() {
    ...
    while (window.isOpen()) {
        ...
        if (lightUpdateClock.getElapsedTime().asSeconds() >= lightUpdateInterval) {
            // Calculate averages for outgoing lanes
            ...
            // Sort the light queue based on averages and A2 condition
            ...
            // Dequeue the top road and set it to green
